...
import a1.example.com.myapplication.Adapter.HappyStudyAdapter;
...
public class GameShopStudyActivity extends AppCompatActivity {

    private List<StoryModel> bookList = new ArrayList<>();
    private HappyStudyAdapter adapterListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_shop_study);
...
//        }
        myHappyNoteRequest();
        adapterListView = new HappyStudyAdapter(GameShopStudyActivity.this,R.layout.item_happy_study,bookList);
        listView = (ListView)findViewById(R.id.list_happy_study);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.setClass(GameShopStudyActivity.this, GameShopStudyDetailActivity.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent();
        intent.setClass(GameShopStudyActivity.this, GameShopActivity.class);
        intent.setAction("user");
        intent.putExtra("username",USERNAME);
        startActivity(intent);
        finish();
    ...
    private void myHappyNoteRequest() {
        URL url = null;
        String urlStr = MyWriteUtils.MyURL+"/selectStudy";
...
//                        Object aa = map.values().iterator().next();
                    ...
                    Toast.makeText(GameShopStudyActivity.this, "请求失败,请检查网络！", Toast.LENGTH_SHORT).show();
                };
