...
public class MyFriendsActivity extends AppCompatActivity {
    ...
    SendShareDialog sendShareDialog;
    private void sendMyFriends() {
        sendShareDialog = new SendShareDialog(this,R.style.AppTheme,new MyOnClickListener());
        sendShareDialog.show();
    }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.send_myfriends:
                    String my_friends_shares_message = sendShareDialog.my_friends_shares_message.getText().toString().trim();
                    if (my_friends_shares_message.equals("")){
                        Toast.makeText(MyFriendsActivity.this, "请输入您要发送的内容！", Toast.LENGTH_SHORT).show();
                    }else{
                        requestSendMyshares(my_friends_shares_message);
                    }
                    break;
    ...
    private void requestSendMyshares(String my_friends_shares_message) {
        {
            URL url = null;
