...
import a1.example.com.myapplication.Adapter.UserShareAdapter;
...
public class MyFriendsSharesActivity extends AppCompatActivity {

    private List<UserShareModel> userShareModels = new ArrayList<>();
    String USERNAME = "";
    String RESULT = "";
    String TEXTNAME = "";
    private UserShareAdapter adapterListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_friends_shares);
    ...
    private void initData() {
        myFriendsSharesRequest();
        adapterListView = new UserShareAdapter(MyFriendsSharesActivity.this,R.layout.item_myfriends_shares,userShareModels);
        listView = (ListView)findViewById(R.id.list_my_friends_shares);
    ...
    private void myFriendsSharesRequest() {
        URL url = null;
        String urlStr = MyWriteUtils.MyURL+"/selectSharesByName";
...
//                        Object aa = map.values().iterator().next();
                        ...
                        String shares = (String) aaa.get("shares");
                        String sharesurl = (String) aaa.get("sharesurl");
                        String sharesdt = (String) aaa.get("sharesdt");
                        userShareModel.setUsername(username);
                        userShareModel.setSharesurl(sharesurl);
                        userShareModel.setShares(shares);
                        userShareModel.setSharesdt(sharesdt);
                        userShareModels.add(userShareModel);
                    }
                    String userFoot = "查看了朋友圈";
                    ...
                    Toast.makeText(MyFriendsSharesActivity.this, "设置失败,请检查网络！", Toast.LENGTH_SHORT).show();
                };
    ...
    public void onBackPressed() {
        ...
        intent.setClass(MyFriendsSharesActivity.this, MyFriendsActivity.class);
