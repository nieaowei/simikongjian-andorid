...
public class GameShopStoryDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_shop_story_detail);
    ...
    private void initData() {
        ...
        if (storyDetailModels.size()>0){
            ...
            TextView text = (TextView) this.findViewById(R.id.story_detial);
            text.setText(aaa);
        }
    }
    ...
    public void onBackPressed() {
        ...
        intent.setClass(GameShopStoryDetailActivity.this, GameShopStoryActivity.class);
    ...
    private void requestStoryDetail() {
        URL url = null;
        String urlStr = MyWriteUtils.MyURL+"/selectStoryDetail";
        ...
        try {
            ...
            if(HttpURLConnection.HTTP_OK==httpURLConnection.getResponseCode()){
                ...
                if (!RESULT.equals("")){
                    ...
                    String userFoot = "看了"+TEXTNAME;
                    RecordUserFootUtil.recordUserFoot(USERNAME,userFoot);

                }else{
                    Toast.makeText(GameShopStoryDetailActivity.this, "设置失败,请检查网络！", Toast.LENGTH_SHORT).show();
                };
